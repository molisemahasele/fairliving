...
if(isset($_POST['filter']))
{
    ...
    header("location: location_search.php?type=$type&&location=$location");
}
?>
<!doctype html>
<html lang="en">
...
if(isset($_GET['type']))
{
    if(isset($_GET['location']))
    {
        $location = $_GET['location'];
        $houseType= $_GET['type'];
        $select = mysqli_query($conn, "SELECT * FROM posts WHERE houseType='$houseType' AND location='$location'");
    }
    else
    {
        $houseType= $_GET['type'];
...
else
{
    ...
    {
        $location = $_GET['location'];
        $select = mysqli_query($conn, "SELECT * FROM posts WHERE location='$location'");
    }
    else
    {
...
else
{
    ...
    {
        $location = $_GET['location'];
        $select = mysqli_query($conn, "SELECT * FROM posts WHERE location='$location' ORDER BY id DESC LIMIT " . $this_page_first_result . ',' . $results_per_page );
    }
    else
    {
        $select = mysqli_query($conn, "SELECT * FROM posts ORDER BY id DESC LIMIT " . $this_page_first_result . ',' . $results_per_page );
      ...
      <div class="row mt-3">
        ...
        <div class="col-md-3 col-lg-4 col-xl-3 mx-auto mb-4">
          ...
          <h6 class="text-uppercase fw-bold mb-4">
            <i class="fas fa-gem me-3"></i>An-k
          </h6>
          <p>
